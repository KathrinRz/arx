...
public class ConfigSplitAndReplaceStringMasker {
	...
	public ConfigSplitAndReplaceStringMasker (Display d, int x, int y){
		s1=new Shell(d);
		s1.setSize(500, 500);
    ...
    SetLabelText(label1,20,20,200,20,text1,220,20,100,20,"SplitAtOccurrencesOf:","@",5);
    SetLabelText(label2,20,50,200,20,text2,220,50,100,20,"ReplacementString:","*",5);
    SetLabelText(label3,20,80,200,20,text3,220,80,100,20,"ReplaceGroupWithIndex:","0",0);
    SetLabelText(label4,20,110,200,20,text4,220,110,100,20,"ReplacingEachCharacter:","false",4); //wenn true -> jeder Buchstabe wird einzeln ersetzt
                                                                                                // wenn false -> ganze Gruppe wird ersetzt.
