...
public class ConfigRandomShiftDateMasker {
	...
	public ConfigRandomShiftDateMasker (Display d, int x, int y){
		s1=new Shell(d);
		s1.setSize(500, 500);
    ...
    SetLabelText(label1,20,20,120,20,text1,220,20,100,20,"ShiftConstant:","0",0);
    SetLabelText(label2,20,60,120,20,text2,220,60,100,20,"Period:","05y 04m 03d 01h",3);
	...
	combo2.setBounds(20,120,200,20);
