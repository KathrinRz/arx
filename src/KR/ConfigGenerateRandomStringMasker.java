...
//			private Label l2;
			...
			public ConfigGenerateRandomStringMasker(Display d, int x, int y) {
				s1 = new Shell(d);
				s1.setSize(500,500);
		        ...
		        text4=new Text(s1, SWT.MULTI);
		        text5=new Text(s1, SWT.SINGLE);
		        text6=new Text(s1, SWT.SINGLE);
				
				SetLabelText(label1,20,20,80,20,text1,220,20,30,20,"Int:","-1",0); //The number of characters the replacement shall consist of. 
																				   //If length < 0, the length of the input is used.
				SetLabelText(label2,20,60,120,20,text2,220,60,100,20,"Boolean:","true",4); // if true, alphabetic characters may be generated.
				SetLabelText(label3,20,100,120,20,text3,220,100,100,20,"Boolean:","false",4); //if true, numeric characters may be generated
				SetLabelText(label4,20,140,120,20,text4,220,140,100,60,"Char []:","null",5); //An optional set of characters to choose from. 
