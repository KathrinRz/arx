...
public class ConfigReplaceInstMasker {
	...
	public ConfigReplaceInstMasker (Display d, int x, int y){
		s1=new Shell(d);
		s1.setSize(500, 500);
    ...
    SetLabelText(label1,20,20,120,20,text1,220,20,100,20,"ReplacementValue:","0",5); //T = irgendwas, konstanter ReplacementValue
