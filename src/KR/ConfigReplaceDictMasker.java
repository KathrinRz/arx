...
public class ConfigReplaceDictMasker {
	...
	public ConfigReplaceDictMasker (Display d, int x, int y){
		s1=new Shell(d);
		s1.setSize(500, 500);
    ...
    SetLabelText(label1,20,20,120,20,text1,220,20,100,80,"ReplacementList:","1,2,3,4",5);
