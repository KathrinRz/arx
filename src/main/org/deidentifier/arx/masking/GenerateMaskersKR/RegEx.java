...
public class RegEx {
	...
	/**
	 * Testet Felder, die Double erwarten, ob Eingabe nur Zahlen und (optional) genau einen Punkt enthalten
	 * @param s
	 * @return
	 */
	 ...
	 public static boolean regExDate(String s){
		 ...
		 /**
		  * Es wird getestet, ob Trennzeichen (-, ,:)  an der richtigen Stelle stehen
		  */
		 ...
		 /**
		  * Jahresangabe soll zwischen 1900 und 3000 liegen(=> für Schaltjahrbestimmung wichig)
		  */
	...
	/**
	 * Testet, ob Zeitraum nur gültige Eingaben enthält(Zahlen, y(für year),m(month),d(day),h(hour) und -). - wird deshabl mitaufgenommen,
	 * da es manchmal sinnvoller ist, beispielsweise 3 d -1h anzugeben statt 2 d 23 h(Sommer-/Winterzeitumstellung etc.). 
	 * @param s
	 * @return
	 */
	 ...
	 public static boolean regExPeriod(String s){
			...
			/**
			 * Es wird getestet, ob die Buchstaben y,m,d,h nur jeweils genau einmal vorkommen
			 */
			int anzY=0;
			for(int i =0;i<s.length();i++){
			...
			/**
			 * Testet, ob der Zeitraum in der richtigen Reihenfolge angegeben wurde(Jahre vor Monaten vor Tagen vor Stunden) 
			 * @param s
			 * @return
			 */
